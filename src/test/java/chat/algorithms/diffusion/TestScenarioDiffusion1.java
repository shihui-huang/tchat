...
public class TestScenarioDiffusion1 extends Scenario {
    @Test
    @Override
    public void constructAndRun() throws Exception {
        ...
        Predicate<ChatMsgContent> conditionForInterceptingI1OnC3 = msg -> msg.getSender() == c1.identity() && msg.getVectorClock().getEntry(msg.getSender()) == 0;
        Predicate<ChatMsgContent> conditionForExecutingI1OnC3 = msg -> c3.getNbChatMsgContentReceived() == 1;
        ...
        emulateAnInputLineFromTheConsoleForAClient(c1, "message 2 from c1 (" + c1 + ")");
        if (LOG_ON && TEST.isInfoEnabled()) {
        ...
        vectorClock.setEntry(100, 2);
        vectorClock.setEntry(101, 0);
